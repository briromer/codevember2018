...
function draw() {
  ...
  for (let i = 0; i < numTriangles; i++){
    ...
    // if (random(100) < 0.2) {
    //   curveTightness(random(100))
    //   fill(b[0].hue, 30, 90)
    //   // noFill()
    // 	// triangle(b[0].position.x, b[0].position.y, b[1].position.x, b[1].position.y, b[2].position.x, b[2].position.y)
    // 	curve(b[0].position.x, b[0].position.y, b[1].position.x, b[1].position.y, b[2].position.x, b[2].position.y, b[3].position.x, b[3].position.y)
    // }
  }
...
Boid.prototype.render = function() {
  // fill(127, 127);
  // stroke(200);
  if(random(100) < 90) this.hue--
  stroke(this.hue, 30, 20)
