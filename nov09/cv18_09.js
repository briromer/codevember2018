...
let plotW = 500,
	...
	inc = 0.1,
	strokeMax = 4,
	maxDrawings = 70 + Math.random() * 100, //+ Math.random() * 400,
	drawingIteration = 0,
	hue = 0,
	walkers = [],
...
draw = () => {
	...
	strokeWeight(2)
	var r = 4 + random(70)
	ellipse(-random(width) + random(width), -random(height) + random(height), r, r)
...
class Walker {
	constructor() {
		...
		this.hue = 20 + random(10)
		this.rNoise = 50 + random(250)
		this.rz = random(1) / 80
		this.rx = random(1) / 50
		this.ry = random(1) / 10
	}
